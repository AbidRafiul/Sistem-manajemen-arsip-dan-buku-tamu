...
export async function up(knex) {
  ...
  await changeColumn(
    ...
    "Direction",
    "direction",
    "ENUM('incoming','outgoing','both') NOT NULL DEFAULT 'both'",
  );
  await changeColumn(
    knex,
    "mst_letter_types",
  ...
  await changeColumn(
    ...
    "Status",
    "status",
    "ENUM('baru','diproses','didisposisi','selesai') NOT NULL DEFAULT 'baru'",
  );
  ...
  await changeColumn(
    ...
    "Status",
    "status",
    "ENUM('baru','dibaca','diproses','selesai') NOT NULL DEFAULT 'baru'",
  );
