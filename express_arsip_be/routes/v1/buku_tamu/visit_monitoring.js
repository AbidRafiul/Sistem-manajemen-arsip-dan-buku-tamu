...
router.post("/", async (req, res) => {
  try {
    ...
    const chart_per_purpose_raw = await DB.raw("SELECT mp.Name as purpose, COUNT(*) as count FROM trx_visitations t LEFT JOIN mst_visit_purposes mp ON t.VisitPurposeId=mp.Id WHERE DATE(t.CheckInTime)=? GROUP BY t.VisitPurposeId", [today]);
