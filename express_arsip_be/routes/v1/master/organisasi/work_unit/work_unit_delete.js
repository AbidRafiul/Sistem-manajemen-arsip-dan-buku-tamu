...
router.delete("/:work_unit_id", async (req, res) => {
  ...
  try {
    ...
    Logging(error, { file: "work_unit_delete.js", func: "delete", request: oPayload, response: oResult, user: cUsername });
