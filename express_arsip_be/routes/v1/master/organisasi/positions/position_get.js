...
router.get("/", async (req, res) => {
  ...
  try {
    const vaData = await DB("mst_positions")
      .select("PositionId", "PositionCode", "PositionName", "PositionLevel", "Description", "Status")
      .where("Status", "active");
    ...
    Logging(error, { file: "position_get.js", func: "get", request: oPayload, response: oResult, user: cUsername });
