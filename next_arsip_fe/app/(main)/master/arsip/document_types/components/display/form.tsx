            ...
            <Dialog visible={isDialogVisible} style={{ width: '500px' }} header={state.add ? 'Tambah Jenis Dokumen' : 'Ubah Jenis Dokumen'} modal onHide={hideDialog} className="p-fluid">
                <form onSubmit={formik?.handleSubmit} className="flex flex-column gap-4 mt-2 fadein animation-duration-300">
                    <div className="flex flex-column gap-2 w-full">
                        <label htmlFor="kode_jenis_dokumen" className="font-semibold text-sm text-700">Kode Jenis Dokumen</label>
                    ...
                    <div className="flex flex-column gap-2 w-full">
                        <label htmlFor="nama_jenis_dokumen" className="font-semibold text-sm text-700">Nama Jenis Dokumen</label>
