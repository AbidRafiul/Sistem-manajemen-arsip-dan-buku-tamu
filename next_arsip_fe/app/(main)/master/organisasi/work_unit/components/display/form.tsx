                ...
                <form onSubmit={formik?.handleSubmit} className="flex gap-2 flex-column mt-2">
                    <div className="flex md:flex-row flex-column gap-2 w-full">
                        ...
                        <div className="flex flex-column gap-2 w-full">
                            ...
                            <div className="p-inputgroup">
                                <InputText id="kode_unit_kerja" name="kode_unit_kerja" value={formik?.values.kode_unit_kerja} style={{ padding: '1rem' }} onChange={formik?.handleChange} className={isFormFieldInvalid('kode_unit_kerja') ? 'p-invalid' : ''} />
                            </div>
                    ...
                    <div className="flex md:flex-row flex-column gap-2 w-full">
                        <div className="flex flex-column gap-2 w-full">
                            <label htmlFor="nama_unit_kerja" className="font-bold">Nama Unit Kerja</label>
                            <div className="p-inputgroup">
                                <InputText id="nama_unit_kerja" name="nama_unit_kerja" value={formik?.values.nama_unit_kerja} style={{ padding: '1rem' }} onChange={formik?.handleChange} className={isFormFieldInvalid('nama_unit_kerja') ? 'p-invalid' : ''} />
                            </div>
