...
export async function up(knex) {
  ...
  await renameIfExists(knex, "tr_visitations", "Guestsurel", "guest_surel");
  ...
  await renameIfExists(knex, "tr_visitations", "NamaPengguna", "nama_pengguna");
  await renameIfExists(
    knex,
    "tr_visitations",
    "VisitPurposeId",
...
export async function down(knex) {
  ...
  if (hasNewTable) {
    ...
    await renameIfExists(knex, "tr_visitations", "guest_surel", "Guestsurel");
    await renameIfExists(
      knex,
      "tr_visitations",
      "guest_company",
