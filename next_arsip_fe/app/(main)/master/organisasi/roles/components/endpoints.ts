...
export const apiEndpointPermissionsGet = '/master/organisasi/roles/permissions/get';
export const apiEndpointPermissionsUpdate = '/master/organisasi/roles/permissions/update';
